...
//	// Constructor
//	public Product(String id, Name name, Image image, Category category, String description, Nutritions nutritions,
//			AvailableStock availStock, Quantity quantity, boolean status) {
//		this.id = id;
//		this.setName(name);
//		this.setImage(image);
